...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        const modifyLatestTransactions = latestTransaction.map((i) => ({
            _id: i.id,
            discount: i.discount,
            amount: i.total,
        ...
        stats = {
            ...
            userRatio,
            latestTransaction: modifyLatestTransactions,
        };
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key))
        ...
        // const categories = await Category.find().select("name").lean(); // to do find lean func do
        ...
        const [proccessingOrder, shippedOrder, deliveredOrder, categories, productsCount, outOfStock, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
